...
import * as strings from 'NkuWebpartWebPartStrings';
import WebApiClient from './components/WebApiClient';
import { IWebApiClientProps } from './components/IWebApiClientProps';

export interface INkuWebpartWebPartProps {
	remoteApiHost: string;
	appInstanceId: string;
}

export default class NkuWebpartWebPart extends BaseClientSideWebPart<INkuWebpartWebPartProps> {
